...
namespace Gaskellgames
{
    ...
    public class InfoBoxAttribute : PropertyAttribute
    {
        ...
        public GgMaths.LogicGate LogicGate;
        ...
        public InfoBoxAttribute(string message, InfoMessageType messageType = InfoMessageType.Info)
        {
            ...
            LogicGate = GgMaths.LogicGate.AND;
        ...
        public InfoBoxAttribute(string message, string[] fields, object[] comparisons)
        {
            ...
            this.isConditional = true;
            this.LogicGate = GgMaths.LogicGate.AND;
        ...
        /// <exception cref="NullReferenceException"></exception>
        /// <exception cref="ArgumentException"></exception>
        public InfoBoxAttribute(string message, InfoMessageType messageType, string[] fields, object[] comparisons, GgMaths.LogicGate logicGate = GgMaths.LogicGate.AND)
        {
            this.message = message;
            this.messageType = messageType;
