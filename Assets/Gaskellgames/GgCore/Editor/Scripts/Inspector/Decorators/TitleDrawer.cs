...
namespace Gaskellgames.EditorOnly
{
    ...
    public class TitleDecorator : DecoratorDrawer
    {
        ...
        private void SetupStyles(TitleAttribute.Alignment alignment)
        {
            // title
            ...
            switch (alignment)
            {
                case TitleAttribute.Alignment.Left:
                    titleStyle.alignment = TextAnchor.MiddleLeft;
                    subTitleStyle.alignment = TextAnchor.MiddleLeft;
                    break;
                case TitleAttribute.Alignment.Center:
                    titleStyle.alignment = TextAnchor.MiddleCenter;
                    subTitleStyle.alignment = TextAnchor.MiddleCenter;
                    break;
                case TitleAttribute.Alignment.Right:
