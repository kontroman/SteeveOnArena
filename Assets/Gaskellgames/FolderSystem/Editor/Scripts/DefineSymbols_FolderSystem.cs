...
namespace Gaskellgames.FolderSystem.EditorOnly
{
    ...
    public class DefineSymbols_FolderSystem
    {
        ...
        private static readonly string error = $"{link_GgCore} not detected: The Folder System package from Gaskellgames requires {link_GgCore}. Please download the required package from the unity asset store!";
